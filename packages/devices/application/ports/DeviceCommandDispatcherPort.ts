...
export interface DeviceCommandDispatcherPort {
   ...
   * 
   * Soporta tanto comandos simples (string) como comandos parametrizados (DeviceCommandRequest).
   */
  dispatch(deviceId: string, command: DeviceCommandV1 | DeviceCommandRequest): Promise<void>;
}
