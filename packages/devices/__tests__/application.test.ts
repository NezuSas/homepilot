...
describe('Módulo Devices - Capa de Aplicación', () => {
  ...
  describe('discoverDeviceUseCase', () => {
    ...
    it('debe interrumpir el flujo lazando un DeviceConflictError (409) explícito asumiendo colisión si existe un duplicado mapeado', async () => {
      await repo.saveDevice({ id: 'd1', homeId: 'h1', externalId: 'ext1', roomId: null, status: 'PENDING', integrationSource: 'ha', invertState: false, lastKnownState: null, name: 'n', type: 't', vendor: 'v', entityVersion: 1, createdAt: 'x', updatedAt: 'x' });
