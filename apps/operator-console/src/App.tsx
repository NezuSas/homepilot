  ...
  return (
    ...
    >
      ...
      <aside className={cn(
        ...
        <nav className={cn("flex-1 overflow-y-auto py-3 px-2.5 flex flex-col gap-0.5 custom-scrollbar transition-all duration-300", isSidebarContentCollapsed && "xl:hidden")}>
