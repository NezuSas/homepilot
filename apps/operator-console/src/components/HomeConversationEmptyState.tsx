...
export const HomeConversationEmptyState: React.FC<HomeConversationEmptyStateProps> = ({
  ...
  <div className="flex min-h-[42vh] items-center justify-center py-4 md:min-h-[50vh] xl:min-h-[56vh]">
    <Card variant="glass" className="w-full max-w-5xl overflow-hidden p-4 md:p-6 xl:p-8">
        ...
        <div className="min-w-0 space-y-5">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
            ...
            <div className="min-w-0">
              ...
              <h3 className="mt-1 text-2xl font-black tracking-tight text-foreground md:text-4xl">
                {title}
              </h3>
              <p className="mt-3 max-w-3xl text-sm font-medium leading-relaxed text-muted-foreground md:text-base">
                {description}
              </p>
            </div>
          </div>
