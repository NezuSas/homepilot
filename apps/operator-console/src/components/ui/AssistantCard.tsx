      ...
      >
        ...
        <div className="flex shrink-0 flex-col items-start gap-4">
          <div className={cn(
            ...
            <Icon aria-hidden="true" className={cn("w-6 h-6", iconClassName)} />
          </div>
        </div>
        ...
        <div className="flex min-w-0 flex-1 flex-col justify-center">
            ...
            <h3 id={titleId} className={cn("mb-2 break-words text-section-title font-bold tracking-tight", severity ? severityTextClasses[severity] : "text-foreground")}>{title}</h3>
            <p id={descriptionId} className="mb-4 break-words text-body font-medium leading-relaxed text-muted-foreground/80 sm:mb-6">
                {description}
            </p>
