...
export const AutomationBuilderSubmitButton: React.FC<AutomationBuilderSubmitButtonProps> = ({
  ...
  <div className="pb-4 pt-2">
    <button
      disabled={disabled}
      onClick={onClick}
      className="hp-type-control flex w-full items-center justify-center gap-4 rounded-[2rem] bg-primary py-5 text-primary-foreground shadow-[0_18px_38px_hsl(var(--primary)/0.24)] transition-all hover:translate-y-[-1px] hover:shadow-[0_22px_46px_hsl(var(--primary)/0.28)] active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-35 disabled:hover:translate-y-0 disabled:hover:shadow-none"
    >
