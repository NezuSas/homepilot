...
- [x] **AC24**: Las luces de una Room mantienen nombre, estado y control en columnas estables. Las etiquetas Encendido y Apagado son compactas, legibles y no se desbordan ni cambian de posición cuando varía el nombre del dispositivo.
