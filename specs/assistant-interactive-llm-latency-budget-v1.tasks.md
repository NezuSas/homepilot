...
- [x] REQ-01/REQ-02: Use no more than 320 characters of authorized ultra-light context and an explicit 1,500 ms / 32-token budget for conversational Ollama requests.
...
- [x] AC1/AC2: `assistant_small_talk_service.test.ts` verifies the 320-character context cap, user scoping, and Ollama options.
