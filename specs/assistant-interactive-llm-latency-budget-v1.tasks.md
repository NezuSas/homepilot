...
- [x] REQ-01/REQ-02: Use no more than 160 characters of authorized ultra-light context, a compact seven-word response contract, and an explicit 2,500 ms / 32-token budget for conversational Ollama requests.
