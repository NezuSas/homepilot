...
- [x] Remove Ollama checks from supported installation and maintenance scripts.
...
- [x] Composition and deployment checks verify that no supported runtime profile references Ollama or a conversational model provider.
