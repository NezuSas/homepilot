...
- Eliminar la regla después de que el motor la intente ejecutar, evitando que se repita al día siguiente.
...
- [x] **AC3:** Una regla con `dateLocal` se ejecuta solo en dicha fecha y se elimina después.
