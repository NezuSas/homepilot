...
- **AC13:** En la consola de operador, interactuar con el selector de Room durante la asignación/importación de un dispositivo no debe disparar la apertura del inspector lateral del dispositivo.
