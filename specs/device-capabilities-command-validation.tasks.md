...
- [x] **T1.1: Definir Diccionario de Capacidades V1**
...
- [x] **T1.2: Implementar UnsupportedCommandError**
...
- [x] **T1.3: Exponer Servicio de Dominio para Validación**
...
- [x] **T2.1: Actualizar executeDeviceCommandUseCase con el "Guardián de Capacidad"**
...
- [x] **T2.2: Garantizar Política de Silencio (Audit Log & Dispatcher)**
...
- [x] **T3.1: Mapear UnsupportedCommandError en el ErrorHandler**
...
- [x] **T4.1: Pruebas Unitarias de Dominio (AC1)**
...
- [x] **T4.2: Pruebas de Integración de Aplicación (AC2, AC3)**
...
- [x] **T4.3: Pruebas E2E / Acceptance (AC4)**
