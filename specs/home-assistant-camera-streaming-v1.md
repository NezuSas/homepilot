...
- **REQ-10:** Las tarjetas deben iniciar con un snapshot fresco mientras el stream directo entrega su primer fotograma, para no bloquear su renderizado. Cuando el stream esté listo sustituye el snapshot sin parpadeo. El visor ampliado puede solicitar HLS como mejora; si Home Assistant no conserva un manifiesto o segmento, la UI debe volver automáticamente al stream directo y finalmente a snapshots.
