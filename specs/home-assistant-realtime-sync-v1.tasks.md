...
- [x] Validar AC3, AC4 y AC5 de refresco manual y cierre durante CONNECTING. Evidencia: pps/api/__tests__/DeviceRoutes.refresh.test.ts y suite WebSocket.
- [x] Publicar HomeAssistantStateUpdatedEvent cuando el WebSocket persiste un cambio de Home Assistant, para refrescar las consolas abiertas sin duplicar los eventos de automatización. Evidencia: __tests__/buildHomeAssistantModule.test.ts.
