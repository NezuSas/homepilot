...
- **REQ-59:** El sidebar responsive debe cerrarse al activar su fondo exterior y mediante un gesto táctil horizontal hacia la izquierda; el comportamiento aplica solo por debajo del breakpoint de escritorio y no interfiere con el desplazamiento vertical del menú.
...
- [x] AC35: La barra de búsqueda y filtros conserva foco, consulta y filtros disponibles desde 320px; sus columnas se reducen de forma segura y las opciones largas permanecen navegables, completas y sin partir palabras ni desbordar la superficie; en escritorio los filtros de un gestor ocupan el ancho restante junto al título: origen compacto y tipos repartidos en la franja amplia, sin una banda vacía.
...
- [x] AC68: En móvil y tablet, el sidebar abierto se cierra al tocar el fondo exterior o deslizar el panel hacia la izquierda; el gesto vertical no provoca cierre y el sidebar de escritorio conserva su comportamiento de rail.
...
- [x] AC70: Inicio, Asistente, topología e inventario reducen cabeceras y etiquetas repetidas; las sugerencias de Inicio presentan título como foco, categoría y prioridad discretas, descripción legible y acciones en un pie compacto, los dispositivos agrupados no repiten la estancia en su nombre o pie, los nombres largos pueden ocupar dos líneas sin desbordar, las etiquetas de auditoría conservan una escala técnica compacta y los controles de seguridad de usuarios mantienen columnas alineadas.
