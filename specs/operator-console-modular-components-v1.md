...
- [x] AC35: La barra de búsqueda y filtros conserva foco, consulta y filtros disponibles desde 320px; sus columnas se reducen de forma segura y las opciones largas permanecen navegables, completas y sin partir palabras ni desbordar la superficie; en escritorio los filtros de un gestor se alinean junto a su título, sin una banda vacía entre ambos.
