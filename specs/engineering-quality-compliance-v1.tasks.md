...
- [x] AC3: `check:bdd-traceability` exige 21 flujos únicos Given/When/Then, incluido el snapshot y timeline de diagnósticos autenticados.
...
- [ ] AC5: Descomponer orquestadores pendientes por responsabilidad cohesionada.
